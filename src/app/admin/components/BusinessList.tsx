      ...
      <header className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap">
          ...
          <select
            ...
            className="w-full rounded-2xl border border-white/50 bg-white/60 px-4 py-2 text-sm shadow-sm transition focus:border-red-400 focus:outline-none focus:ring-2 focus:ring-red-200 dark:border-white/20 dark:bg-white/5 sm:w-auto"
          >
      ...
      <td className="px-6 py-4 text-center">
        <div className="flex flex-wrap items-center justify-center gap-2">
          ...
          <select
            ...
            className="rounded-xl border border-white/60 bg-white px-3 py-1.5 text-xs font-semibold text-zinc-600 transition focus:border-red-400 focus:outline-none focus:ring-1 focus:ring-red-200 dark:border-white/20 dark:bg-white/5 dark:text-zinc-200"
          >
