const stores = [
  ...
  },
  {
    ...
    rating: 4.2,
    promo: null,
    image: "https://images.unsplash.com/photo-1600891965059-04f2819d7d5a?auto=format&fit=crop&w=800&q=80",
  },
  {
  ...
  },
  {
    ...
    rating: 4.0,
    promo: "2x1 en martes",
    image: "https://images.unsplash.com/photo-1604908177085-53053fe5586f?auto=format&fit=crop&w=800&q=80",
  },
  {
    name: "Snack's Jailys",
    category: "Snacks",
...
const promotions = [
  {
    ...
    description: "Obtén 30% de descuento en pedidos eco-friendly durante esta semana.",
    cta: "Ordenar ahora",
    ...
    <div className="min-h-screen bg-white/80 text-foreground">
      <header className="border-b border-black/5 bg-white/90 backdrop-blur">
        <div className="container mx-auto flex flex-col gap-2 px-4 py-6 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-sm font-medium text-muted-foreground">Entrega a</p>
            <h1 className="text-3xl font-bold text-foreground">Todas las tiendas</h1>
          </div>
      ...
      <main className="container mx-auto px-4 py-10">
        <section className="space-y-4">
          <header className="flex items-center justify-between">
            <h2 className="text-xl font-semibold text-foreground">¿Qué necesitas hoy?</h2>
            <button className="text-sm font-semibold text-emerald-700 hover:text-emerald-800">Ver todo</button>
          </header>
        ...
        <section className="mt-8 space-y-4">
          <header className="flex items-center justify-between">
            <h2 className="text-xl font-semibold text-foreground">Promociones destacadas</h2>
            <button className="text-sm font-semibold text-emerald-700 hover:text-emerald-800">Ver promociones</button>
          </header>
            ...
            {promotions.map((promo) => (
              ...
              >
                ...
                <div className="relative space-y-3 p-6">
                  ...
                  <h3 className="text-2xl font-semibold leading-tight drop-shadow-sm">{promo.title}</h3>
                  <p className="text-sm text-white/80 drop-shadow-sm">{promo.description}</p>
